...
from dataset_rainset import TrainValDataset, TestDataset, TestRealDataset
...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', '--model', default='teacher_520_epoch')
